...
class TransactionSearch extends Transaction
{
    ...
    {
        return [
            [['id', 'invoice_id', 'amount', 'cvc', 'status'], 'integer'],
            [['bank_account', 'creditCardNumber', 'dateStart', 'dateExpiration', 'ownerName'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'bank_account', $this->bank_account])
            ->andFilterWhere(['like', 'creditCardNumber', $this->creditCardNumber])
